/*
 ================================================================
                   igrf2007_matlab_wrapper.c
 ================================================================
  Matlab wrapper for the IGRF subroutines distributed in iri2007
       
  This is a MEX-file for MATLAB.
      
  Change history:
  19/11/08  M.A. Cervera  V1.0  Author
  18/02/10  M.A. Cervera  V2.0  Improved error handling

  13/02/22  M. A. Cervera  V2.1 
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  if (nrhs != 4) {
    mexErrMsgTxt("ERROR: 4 inputs required when calling igrf2007.");
    return;
  }

  if (nlhs != 1) {
    mexErrMsgTxt("ERROR: 1 outputs required when calling igrf2007.");
    return;
  }
