...
%
%       .HNEA  - user input lower Ne boundary (km). Leave undefined to use
%                default values of 65/80 km for day/night.               
%
%       .HNEE   - user input upper Ne boundary (km). Leave undefined to use the
%               default value of 2000km.
%
% Outputs :
...
%                    the Friedrich and Torkar (2001) FIRI model in the
