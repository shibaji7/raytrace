...
%
% Calling sequence :
%    1. [iono, iono_extra] = iri2016_firi_interp(lat, lon, R12, UT, ...
%                                 ht_start, ht_step, num_hts);
%
%    2. [iono, iono_extra] = iri2016_firi_interp(lat, lon, R12, UT, ...
...
%   
% Outputs :
%   iono  -  Array of 14 output parameters x num_hts heights. NB, ionosperic
...
%   V1.0  M. A. Cervera  03/05/2016
%      Based on V1.3  of iri2012_firi_interp.m
%
...
function [iono, iono_extra] = iri2016_firi_interp(site_lat, site_lon, R12, ...
  ...
  iricall_str = ['[iono iono_extra] = iri2016(' iri2016_arg_str ');'];
