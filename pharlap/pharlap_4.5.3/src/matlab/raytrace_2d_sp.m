...
%   for experts only. Spherical earth coordinate system is assumed. 
%    
% Calling sequence:
...
%                    Maximum grid size is 2001 X 2001 elements. This
...
%                    Maximum grid size is 2001 X 2001 elements. This is used
%                    to calculate deviative absorption. If deviative absorption
%                    is not required then the array elements can be set to zero.
...
%   the caclulated absorption is greater than that for O-mode propagation and 
...
%   used or alternatively use 3D NRT (raytrace_3d_sp.mex).
%
