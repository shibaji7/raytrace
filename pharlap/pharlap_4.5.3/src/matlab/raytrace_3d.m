...
%   required. Collisions are not considered (i.e. the refractive index is
%   real not complex). WGS84 coordinate system is assumed.
%
% Calling sequence :
%   The first time raytrace_3d is called, ionospheric and geomagnetic grids
...
%           raytrace_3d(origin_lat, origin_long, origin_ht, elevs, ray_bearings,
%                       freqs, OX_mode, nhops, tol, ray_state_vec_in)
%
% Inputs :
...
%                     start point of rays
%   origin_height   - WGS84 height above sea-level of start point of rays which
...
%                     (All rays have same polarization mode)
...
%            ray (first 5 inputs) will be ignored. The fields of this struture
%            are:
%     .pos_x          - WGS84 cartesian x position of ray start point (m)
%     .pos_y          - WGS84 cartesian y position of ray start point (m)
%     .pos_z          - WGS84 cartesian z position of ray start point (m)
%     .dir_x          - WGS84 cartesian x, y, and z components of vector with a
...
%                  structure are: 
%     .lat                   - geodetic (WGS84) latitude of end point of
%                              ray (degrees) for each hop
%     .lon                   - geodetic (WGS84) longitude of end point of
%                              ray (degrees) for each hop
...
%                      through the equator at longitude of +90 degrees, and z
%                      through the geographic north pole.
%      .pos_x            - WGS84 cartesian x position of ray (m)
%      .pos_y            - WGS84 cartesian y position of ray (m)
%      .pos_z            - WGS84 cartesian z position of ray (m)
%      .dir_x            - WGS84 cartesian x, y, and z components of vector 
