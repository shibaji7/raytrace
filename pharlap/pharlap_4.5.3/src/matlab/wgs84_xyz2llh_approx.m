...
%
% Inputs (vectors of the same size):
%   x, y, z    -  geocentric x,y,z (m)
%
% Outputs (vectors of the same size as input vectors):
...
%     Initial version. 
%
%   19/01/2016 D. J. Netherway 
%     Vectorized the algorithm
%
